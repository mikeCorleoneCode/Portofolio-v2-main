    ...
    <nav class="max-w-7xl px-5 top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-2xl text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">0xPrinz </span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://www.tiktok.com/@0xprinz"><img class="w-9 rounded-full" src="https://images.rawpixel.com/image_png_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvdjk4Mi1kNS0wOC5wbmc.png"></a>
        </div>
